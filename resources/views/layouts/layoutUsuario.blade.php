        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#typeahead").autocomplete({
                    ...
                    .append( "<a><div class='profile-photo'><img class='img-circle' src='"urlImg+"/" + item.imgsrc + "' /></div><div class='message-info'><span class='sender'>"+item.label+" </span><div class='message-content'>"+item.description+"</span></div></a>" )  
                    .appendTo( ul );  
                }
            },
            error: function (data) {
